...
public class StudentService {
  ...
  public StudentDetail searchStudent(String id){
    ...
    List<StudentCourse> studentCourse =
        repository.searchStudentCourseByStudentId(student.getId());
    return new StudentDetail(student, studentCourse);
  }

  /**
   * 受講生詳細の登録を行います。
   * 受講生と受講生コース情報を個別に登録し、受講生コース情報には受講生情報を紐づける値とコース開始日、コース州病美を設定します。
   *
   ...
   * @param student 受講生
   */
  private static void initStudentsCourse(StudentCourse studentCourses, Student student) {
